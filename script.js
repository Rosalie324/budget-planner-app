...
const API_URL = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ...
    : 'https://budget-planner-api.onrender.com/api'; // À remplacer par votre URL Render
...
async function addExpense(event) {
    ...
    const newExpense = await addExpenseAPI(currentUserId, category, name, amount, date);
